...
namespace MiniDataTable.Scene
{
    ...
    public partial class TbScene
    {
        ...
        private readonly System.Collections.Generic.Dictionary<int,Scene.SceneRow> _indexDataMap;
        ...
        public TbScene(ByteBuf _buf, string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
            _indexDataMap = new System.Collections.Generic.Dictionary<int, Scene.SceneRow>();
        ...
        public Scene.SceneRow GetByIndex(int index)
        {
            ...
            v = Scene.SceneRow.DeserializeSceneRow(buf);;
            _indexDataMap[index] = v;
            v.ResolveRef(_tables);
            return v;
        }

        public void LoadAll(System.Action<int,Scene.SceneRow> onLoad = null)
        {
